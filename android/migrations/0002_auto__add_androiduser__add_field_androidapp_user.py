...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AndroidUser'
        db.create_table(u'android_androiduser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['RSS.User'], unique=True)),
        ))
        db.send_create_signal(u'android', ['AndroidUser'])

        # Adding field 'AndroidApp.user'
        db.add_column(u'android_androidapp', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['android.AndroidUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AndroidUser'
        db.delete_table(u'android_androiduser')

        # Deleting field 'AndroidApp.user'
        db.delete_column(u'android_androidapp', 'user_id')
